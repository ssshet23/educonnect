  ...
  <body>
    ...
    <section class="header">
        <div class="navbar">
            ...
            <ul>
              <li><a href="inndex.html">Home</a></li>
    ...
    <script>
      function updateSearchOptions() {
          ...
          else if (category === "Pre-University") {
        // Show the subCategory dropdown
        subCategory.style.display = 'block';

        // Populate with specific options for Pre-University
        subCategory.innerHTML = ''; // Clear existing options first
        ["Science", "Commerce", "Arts"].forEach(function(item) {
            var option = document.createElement("option");
            option.value = option.textContent = item;
            subCategory.appendChild(option);
        });
        ...
        // Populate with specific options for Pre-University
        subCategory.innerHTML = ''; // Clear existing options first
        ["BSC", "BCOM", "ENGINEERING","MEDICAL"].forEach(function(item) {
            var option = document.createElement("option");
            option.value = option.textContent = item;
            subCategory.appendChild(option);
        });
    } 
    else if (category === "Post Graduate") {
        // Show the subCategory dropdown
        subCategory.style.display = 'block';

        // Populate with specific options for Pre-University
        subCategory.innerHTML = ''; // Clear existing options first
        ["MBA", "MTECH", "MD"].forEach(function(item) {
            var option = document.createElement("option");
            option.value = option.textContent = item;
            subCategory.appendChild(option);
        });
      ...
      document.getElementById("searchForm").addEventListener("submit", function(event) {
        ...
        if (subCategory === "Science") {
            window.location.href = "http://localhost/science.php";
        } else if (subCategory === "Commerce") {
            window.location.href = "http://localhost/commerce.php";
        } else if (subCategory === "Arts") {
            window.location.href = "http://localhost/arts.php";
        }
    } 
    else if (category === "Undergraduate") {
        if (subCategory === "BCOM") {
            window.location.href = "http://localhost/bcom.php";
        } else if (subCategory === "BSC") {
            window.location.href = "http://localhost/bsc.php";
        } else if (subCategory === "ENGINEERING") {
            window.location.href = "http://localhost/engg.php";
        } else if (subCategory === "MEDICAL") {
            window.location.href = "http://localhost/mbbs.php";
        }
    }
    else if (category === "Post Graduate") {
        if (subCategory === "MBA") {
            window.location.href = "http://localhost/mba.php";
        } else if (subCategory === "MTECH") {
            window.location.href = "http://localhost/mtech.php";
        } else if (subCategory === "MD") {
            window.location.href = "http://localhost/md.php";
        } 
    } 
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Shanti Sadhan School</h5>
                      <p>"Empowering Minds, Building Futures: Discover, Learn, Grow with Us!"</p>
                    </div>
                  </div>
