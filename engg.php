...
// SQL query to retrieve data from the mbbs table
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<div class='card'>";
        echo "<a href='college_details.php?clg_id=" . $row['clg_id'] . "&college_type=eng'><img src='" . $imagePath . "' alt='College Image'></a>";
        ...
        echo "<p><strong>Review:</strong> " . nl2br($row['clgreview']) . "</p>";
